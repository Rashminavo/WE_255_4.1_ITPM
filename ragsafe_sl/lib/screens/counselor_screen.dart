...
class _CounselorScreenState extends State<CounselorScreen> with TickerProviderStateMixin {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.lock, color: Color(0xFF0F6E56), size: 20),
                  ),
                  const SizedBox(width: 14),
                  const Expanded(
                    child: Text(
                      "Your identity is kept anonymous. Feel free to reach out for support.",
                      style: TextStyle(color: Color(0xFF085041), fontSize: 13, height: 1.4),
                    ),
                  ),
                ],
              ),
            ...
            ..._counselors.asMap().entries.map((entry) => _counselorCard(context, entry.value, entry.key)),
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        child: const Icon(Icons.phone, color: Color(0xFFE24B4A), size: 20),
                      ),
                      const SizedBox(width: 12),
                      const Text("Emergency Hotline",
                          style: TextStyle(fontWeight: FontWeight.bold, color: Color(0xFFE24B4A), fontSize: 16)),
                    ],
                  ),
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        Row(
                          children: [
                            const Icon(Icons.phone_in_talk, color: Color(0xFF1D9E75), size: 18),
                        ...
                        Row(
                          children: [
                            const Icon(Icons.local_phone, color: Color(0xFF1D9E75), size: 18),
                            const SizedBox(width: 10),
  ...
  Widget _counselorCard(BuildContext context, Map<String, dynamic> counselor, int index) {
                              ...
                              if (counselor["available"])
                                  ...
                                  builder: (context, child) {
                                    return ElevatedButton(
                                      style: ElevatedButton.styleFrom(
                                        ...
                                        elevation: 2 + (_pulseController.value * 2),
                                      ),
                                      onPressed: () {
                                ...
                                TextButton(
                                  onPressed: () {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text('${counselor["name"]} is currently offline. Try again later.'),
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          _buildDetailRow(Icons.psychology, "Specialty", counselor["specialty"]),
                          const Divider(height: 24),
                          _buildDetailRow(Icons.people, "Sessions Completed", "${counselor["sessions"] ?? 0}+"),
                          const Divider(height: 24),
                          _buildDetailRow(
                            Icons.access_time,
                            "Availability",
                            counselor["available"] ? "Available Now" : "Currently Offline",
                            valueColor: counselor["available"] ? const Color(0xFF4CAF50) : Colors.grey,
                          ),
                        ],
                      ),
                    ),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: counselor["available"]
                            ...
                            : null,
                        child: Text(
                          counselor["available"] ? "Start Chat" : "Currently Unavailable",
                          style: const TextStyle(
                            color: Colors.white,
                            fontSize: 16,
                            fontWeight: FontWeight.bold,
