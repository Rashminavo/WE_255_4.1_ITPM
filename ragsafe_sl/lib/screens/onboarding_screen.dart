...
class _OnboardingScreenState extends State<OnboardingScreen> with TickerProviderStateMixin {
  ...
  bool _reportDemoSubmitted = false;
  ...
  final List<OnboardingItem> _items = [
    OnboardingItem(
      ...
      description: "Your trusted companion for staying safe on campus. Swipe to explore our powerful features.",
    ...
    OnboardingItem(
      ...
      title: "Emergency SOS",
      description: "One tap sends instant alerts to campus security when you need help.",
    ...
    OnboardingItem(
      ...
      title: "Buddy System",
      description: "Find travel buddies in real-time. Never walk alone on campus.",
    ...
    OnboardingItem(
      ...
      title: "24/7 Support",
      description: "Connect with counselors anonymously. Your mental health matters.",
  ...
  void _selectReportType(int index) {
    setState(() {
      _selectedReportType = index;
      _reportDemoSubmitted = true;
    });
    _demoController.forward(from: 0);
    Future.delayed(const Duration(seconds: 2), () {
      if (mounted) {
        setState(() {
          _reportDemoSubmitted = false;
          _selectedReportType = -1;
        });
      }
    });
  }
      ...
      child: Column(
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              _featureIcon(Icons.warning_amber_rounded, const Color(0xFFE24B4A)),
                ...
                return Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: const Color(0xFFE24B4A).withOpacity(
                      _sosDemoTriggered ? 0.8 : 0.3 + (_pulseController.value * 0.3),
                    ),
                    boxShadow: [
                      BoxShadow(
                        color: const Color(0xFFE24B4A).withOpacity(
                          _sosDemoTriggered ? 0.8 : 0.3 + (_pulseController.value * 0.4),
                        ),
                        blurRadius: _sosDemoTriggered ? 40 : 20 + (_pulseController.value * 20),
                        spreadRadius: _sosDemoTriggered ? 10 : 2 + (_pulseController.value * 3),
                      ),
                    ],
                  ),
                  child: const Icon(
                ...
                AnimatedBuilder(
                  ...
                  builder: (context, child) {
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        shape: BoxShape.circle,
                        color: const Color(0xFF2196F3).withOpacity(0.2 + (_pulseController.value * 0.3)),
                      ),
                      child: const Icon(
                        Icons.search,
                        color: Colors.white,
  ...
  Widget _buildReportDemo(OnboardingItem item) {
    final reportTypes = [
      {"icon": Icons.visibility, "label": "Ragging"},
      {"icon": Icons.security, "label": "Safety"},
      {"icon": Icons.person_off, "label": "Suspicious"},
    ];
                ...
                return GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    child: Column(
                      children: [
                        Icon(
                          reportTypes[index]["icon"] as IconData,
                          color: isSelected 
                              ? const Color(0xFFFF9800)
                              : Colors.white70,
                          size: 24,
                        ...
                        const SizedBox(height: 4),
                        Text(
                          reportTypes[index]["label"] as String,
                          style: TextStyle(
                            color: isSelected 
                                ? Colors.white
                                : Colors.white70,
  ...
  Widget _buildMapDemo(OnboardingItem item) {
    return Container(
      height: 140,
      decoration: BoxDecoration(
        color: Colors.white.withOpacity(0.15),
        ...
        child: Stack(
          children: [
            ...
            Positioned(
              left: 30,
              top: 30,
              child: _buildMapMarker(Icons.security, const Color(0xFF4CAF50), "Safe Zone"),
            ),
            Positioned(
              right: 40,
              top: 50,
              child: _buildMapMarker(Icons.local_hospital, const Color(0xFFE24B4A), "Hospital"),
            ),
            Positioned(
              left: 80,
              bottom: 30,
              child: _buildMapMarker(Icons.location_on, const Color(0xFF9C27B0), "You"),
            ),
          ...
          children: [
            ...
            ...List.generate(8, (index) {
              ...
              return Transform.translate(
                offset: Offset(
                  math.cos(angle + _backgroundController.value * 2 * math.pi) * radius,
                  math.sin(angle + _backgroundController.value * 2 * math.pi) * radius,
                ),
                child: Container(
                  width: 8,
                  height: 8,
