...
class _ProfileScreenState extends State<ProfileScreen> {
                  ...
                  Stack(
                    children: [
                      const CircleAvatar(
                        ...
                        child: Icon(Icons.person, size: 60, color: Color(0xFF1D9E75)),
                      ),
                      if (_isEditing)
                        Positioned(
                          bottom: 0, right: 0,
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            const Divider(),
                            _buildField("Faculty", _facultyController, Icons.school_outlined),
                            const Divider(),
                            _buildPhoneField(),
                          ],
                        ),
                      ...
                      child: Column(
                        children: [
                          ...
                          SwitchListTile(
                            ...
                            onChanged: (val) => setState(() => _isAnonymousMode = val),
                          ),
                        ],
                      ),
                    ),
                                ...
                                ElevatedButton(
                                  ...
                                  onPressed: () {
                                    Navigator.pushAndRemoveUntil(
                                      context,
                                      MaterialPageRoute(builder: (context) => const RagSafeApp()),
                                      (route) => false,
                                    );
                                  },
  ...
  Widget _buildEmailField() {
    return TextFormField(
      ...
      decoration: const InputDecoration(
        ...
        prefixIcon: Icon(Icons.email_outlined, color: Color(0xFF1D9E75), size: 20),
        border: InputBorder.none,
  ...
  Widget _buildPhoneField() {
    return TextFormField(
      ...
      decoration: const InputDecoration(
        labelText: "Phone number",
        prefixIcon: Icon(Icons.phone_outlined, color: Color(0xFF1D9E75), size: 20),
        border: InputBorder.none,
        labelStyle: TextStyle(fontSize: 13),
      ),
      style: const TextStyle(fontSize: 14),
