...
class _DashboardScreenState extends State<DashboardScreen> {
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: const Row(
                            ...
                            children: [
                              Icon(Icons.star, color: Color(0xFF1D9E75), size: 14),
                              SizedBox(width: 4),
                              Text("82 pts",
                                  style: TextStyle(color: Color(0xFF1D9E75), fontSize: 12, fontWeight: FontWeight.bold)),
                            ],
                          ),
                        ),
                      ],
                    ...
                    children: [
                      Expanded(
                        child: _buildQuickAction(
                          ...
                          const Color(0xFFFCEBEB), const Color(0xFFE24B4A),
                          isEmergency: true,
                          onTap: _handleSOS,
                        ),
                      ),
                      ...
                      Expanded(
                        child: _buildQuickAction(
                          Icons.description_outlined, "Report",
                          const Color(0xFFFFF4E1), const Color(0xFFFF9800),
                          onTap: _handleReport,
                        ),
                      ),
                      const SizedBox(width: 12),
                      Expanded(
                        child: _buildQuickAction(
                          ...
                          const Color(0xFFE8F8F2), const Color(0xFF1D9E75),
                          onTap: () {
                            Navigator.push(context,
                    ...
                    child: Column(
                      children: [
                        StreamBuilder<String>(
                          stream: Stream.periodic(const Duration(seconds: 8), (count) {
                            return count % 2 == 0
                          ...
                          builder: (context, snapshot) {
                            return _notificationItem(
                                snapshot.data ?? "Loading alerts...", "Just now", true);
                          },
                        ),
                        const Divider(height: 1),
                        _notificationItem("Buddy Kavindu accepted your request", "1 hr ago", false),
                        const Divider(height: 1),
                        _notificationItem("New ragging awareness tip available", "3 hr ago", false),
                      ],
                    ),
                  ),
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          child: const Icon(Icons.lightbulb_outline, color: Color(0xFF0F6E56), size: 20),
                        ),
  ...
  Widget _buildQuickAction(IconData icon, String label, Color bgColor, Color iconColor,
      {required VoidCallback onTap, bool isEmergency = false, String? heroTag}) {
